...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Na zbiorach z cechami kategorycznymi (Car Evaluation) oraz Wine Quality dodanie SVM pogarszało wyniki -- spadek dokładności odpowiednio z 0,829 do 0,796 oraz z 0,744 do 0,708 przy wzroście $p_{svm}$ od 0\% do 100\%.
    \end{itemize}
