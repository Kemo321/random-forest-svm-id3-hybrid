...
\textbf{Wnioski:}
\begin{itemize}
    \item Na zbiorze Mushroom (rys.~\ref{fig:heatmaps}a) obserwujemy niemal perfekcyjną klasyfikację -- tylko 52 błędy na ponad 200~000 predykcji (zagregowanych z 25 uruchomień). Model popełnia sporadyczne błędy w obu kierunkach.
